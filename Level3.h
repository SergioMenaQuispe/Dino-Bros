...
public:
	...
	std::vector<Platform> GetPlatforms() {
		...
		platforms.push_back(Platform("Images/puerta_dino.png", Vector2f(80.0f, 80.0f), Vector2f(400.0f, 2350.0f)));
		return platforms;
	}
	...
	std::vector<Spike> GetSpikes() {
		...
		/*
		spikes.push_back(Spike("Images/pua_02.png", Vector2f(50.0f, 50.0f), Vector2f(50.0f, 1000.0f)));
		spikes.push_back(Spike("Images/pua_02.png", Vector2f(50.0f, 50.0f), Vector2f(100.0f, 1000.0f)));
		spikes.push_back(Spike("Images/pua_02.png", Vector2f(50.0f, 50.0f), Vector2f(150.0f, 1000.0f)));
		spikes.push_back(Spike("Images/pua_02.png", Vector2f(50.0f, 50.0f), Vector2f(200.0f, 1000.0f)));
		spikes.push_back(Spike("Images/pua_02.png", Vector2f(50.0f, 50.0f), Vector2f(250.0f, 1000.0f)));
		spikes.push_back(Spike("Images/pua_02.png", Vector2f(50.0f, 50.0f), Vector2f(300.0f, 1000.0f)));
		spikes.push_back(Spike("Images/pua_02.png", Vector2f(50.0f, 50.0f), Vector2f(350.0f, 1000.0f)));
		spikes.push_back(Spike("Images/pua_02.png", Vector2f(50.0f, 50.0f), Vector2f(400.0f, 1000.0f)));
		spikes.push_back(Spike("Images/pua_02.png", Vector2f(50.0f, 50.0f), Vector2f(450.0f, 1000.0f)));
		spikes.push_back(Spike("Images/pua_02.png", Vector2f(50.0f, 50.0f), Vector2f(500.0f, 1000.0f)));
		spikes.push_back(Spike("Images/pua_02.png", Vector2f(50.0f, 50.0f), Vector2f(550.0f, 1000.0f)));
		spikes.push_back(Spike("Images/pua_02.png", Vector2f(50.0f, 50.0f), Vector2f(600.0f, 1000.0f)));
		*/
		return spikes;
	}
